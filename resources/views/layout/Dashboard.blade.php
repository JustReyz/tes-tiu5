...
<body>
  ...
  <li class="{{ Request::is('test') ? 'active' : '' }}">
    <a href="{{ route('test.tutor') }}" class="d-flex align-items-center">
        <img src="{{ asset('icon/test.svg') }}" alt="Icon Halaman Tes TIU" class="nav-icon me-2">
        <span class="fw-bold">Halaman Tes TIU</span>
    </a>
</li>

    <li class="{{ Request::is('test/result') ? 'active' : '' }}">
        <a href="{{ route('test.result') }}">
           <img src="{{ asset('icon/hasil.svg') }}" alt="Icon Halaman Hasil Tes TIU" class="nav-icon me-2">
            <p class="fw-bold mb-0">Hasil Tes</p>
        </a>
    </li>
        <li class="{{ Request::is('profile') ? 'active' : '' }}">
        <a href="{{ route('profile.show') }}">
            <img src="{{ asset('icon/user.svg') }}" alt="Icon Profil" class="nav-icon me-2">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        @yield('content') <!-- Halaman tes atau konten lain yang dimuat di sini -->
      </div>
